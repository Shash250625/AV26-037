...
import { LiteModeProvider } from "@/lib/lite-mode";
import { Header } from "@/components/agrolens/Header";
import { Footer } from "@/components/agrolens/Footer";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Snap a leaf, get instant crop disease diagnosis and treatment in your local language. Built for farmers." },
      { name: "author", content: "AgroLens" },
      { property: "og:title", content: "AgroLens — Crop Disease Detection" },
      { property: "og:description", content: "Snap a leaf. Get the diagnosis. In your language." },
